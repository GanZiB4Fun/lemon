package cn.springside.lemon.provider.db.table.model;



import java.util.List;

import cn.springside.lemon.util.typemapping.ActionScriptDataTypesUtils;
import cn.springside.lemon.GeneratorProperties;
import cn.springside.lemon.provider.db.table.model.ForeignKey.ReferenceKey;
import cn.springside.lemon.provider.db.table.model.util.ColumnHelper;
import cn.springside.lemon.util.GLogger;
import cn.springside.lemon.util.StringHelper;
import cn.springside.lemon.util.TestDataGenerator;
import cn.springside.lemon.util.typemapping.DatabaseDataTypesUtils;
import cn.springside.lemon.util.typemapping.JavaPrimitiveTypeMapping;
