...
import cn.springside.lemon.util.AntPathMatcher;
import cn.springside.lemon.util.FileHelper;
import cn.springside.lemon.util.FreemarkerHelper;
...
//		if(outRootDir == null) throw new IllegalStateException("'outRootDir' property must be not null.");
    ...
    public void deleteOutRootDir() throws IOException {
        if(StringHelper.isBlank(getOutRootDir())) throw new IllegalStateException("generator.xml 'outRoot' property must be not null.");
